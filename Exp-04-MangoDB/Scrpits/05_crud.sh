...
banner
echo -e "${GREEN}Step 4 of 7${NC}"
echo
echo "Topic : CRUD Operations"
echo
echo "Learning Objective"
echo "------------------"
echo "Perform Create, Read, Update and Delete operations."
echo
...
open_guide "$(basename guide/03_crud_operations.md)"
echo
echo "Student Activity"
echo "----------------"
echo "Open mongodb/insert_products.js and type the commands manually."
echo
echo "Expected Output"
echo "---------------"
echo "Inserted documents displayed"
echo
echo "Checkpoint"
echo "----------"
...
if [[ "$ans" == "yes" ]]; then
    ...
    echo -e "${YELLOW}Please review guide/03_crud_operations.md and repeat this step.${NC}"
fi
