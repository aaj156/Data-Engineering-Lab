...
banner
echo -e "${GREEN}Step 5 of 7${NC}"
echo
echo "Topic : Indexing"
echo
echo "Learning Objective"
echo "------------------"
echo "Create indexes and analyze query performance."
echo
...
open_guide "$(basename guide/04_indexing.md)"
echo
echo "Student Activity"
echo "----------------"
echo "Open mongodb/indexing.js and type the commands manually."
echo
echo "Expected Output"
echo "---------------"
echo "brand_1 index visible"
echo
echo "Checkpoint"
echo "----------"
...
if [[ "$ans" == "yes" ]]; then
    ...
    echo -e "${YELLOW}Please review guide/04_indexing.md and repeat this step.${NC}"
fi
