...
performance = {
    ...
    "scenario_alert": get_bool("Scenario 2: Alert System"),
    "scenario_multi_device": get_bool("Scenario 3: Multi-device Streaming"),
    "scenario_dlq": get_bool("Scenario 4: Dead Letter Queue"),
    "scenario_stress": get_bool("Scenario 5: Stress Testing"),
    "dashboard_analysis": get_bool("Dashboard Verification"),
    "grafana_monitoring": get_bool("Grafana Monitoring"),
    "notifications_working": get_bool("Email/SMS Notifications"),
    "debugging_attempted": get_bool("Debugging Performed")
}
...
if performance["dashboard_analysis"] and performance["grafana_monitoring"]:
    ...
    remarks.append("Dashboard/Grafana incomplete")
...
filename = f"{student['roll_no']}_Industry_Grade_Testing_Pipeline_report.txt"
